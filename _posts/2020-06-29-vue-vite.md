...
**Running tests:**:
Since React testing utilities depend on React non-ESM distribution, you may have to use directly testing libraries (without React utilities). Or to <span class="bold">wait for React to provide an ESM distribution</span>, which should happen in **v. 17 (2020)**.
